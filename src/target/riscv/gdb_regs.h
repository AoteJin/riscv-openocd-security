...
enum gdb_regno {
	...
	GDB_REGNO_UDCSR = CSR_UDCSR + GDB_REGNO_CSR0,
	GDB_REGNO_UDPC = CSR_UDPC + GDB_REGNO_CSR0,
	GDB_REGNO_SDCSR = CSR_SDCSR + GDB_REGNO_CSR0,
	GDB_REGNO_SDPC = CSR_SDPC + GDB_REGNO_CSR0,
	GDB_REGNO_DSCRATCH0 = CSR_DSCRATCH0 + GDB_REGNO_CSR0,
	GDB_REGNO_MSTATUS = CSR_MSTATUS + GDB_REGNO_CSR0,
	GDB_REGNO_SSTATUS = CSR_SSTATUS + GDB_REGNO_CSR0,
	GDB_REGNO_MEPC = CSR_MEPC + GDB_REGNO_CSR0,
	GDB_REGNO_SEPC = CSR_SEPC + GDB_REGNO_CSR0,
	GDB_REGNO_MCAUSE = CSR_MCAUSE + GDB_REGNO_CSR0,
	GDB_REGNO_SCAUSE = CSR_SCAUSE + GDB_REGNO_CSR0,
	GDB_REGNO_MTVAL = CSR_MTVAL + GDB_REGNO_CSR0,
	GDB_REGNO_STVAL = CSR_STVAL + GDB_REGNO_CSR0,
